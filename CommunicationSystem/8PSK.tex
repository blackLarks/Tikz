...
\begin{tikzpicture}[scale=3]
    ...
    \fill[red!20] (0,0) -- (1.5,0) -- (1.5,1.5) -- (0,0) -- cycle;
    \fill[blue!20] (0,0) -- (1.5,1.5) -- (0,1.5) -- (0,0) -- cycle;
    \fill[green!20] (0,0) -- (-1.5,1.5) -- (0,1.5) -- (0,0) -- cycle;
    \fill[yellow!20] (0,0) -- (-1.5,0) -- (-1.5,1.5) -- (0,0) -- cycle;
    \fill[red!50] (0,0) -- (-1.5,0) -- (-1.5,-1.5) -- (0,0) -- cycle;
    \fill[blue!50] (0,0) -- (-1.5,-1.5) -- (0,-1.5) -- (0,0) -- cycle;
    \fill[green!50] (0,0) -- (1.5,-1.5) -- (0,-1.5) -- (0,0) -- cycle;
    \fill[yellow!50] (0,0) -- (1.5,0) -- (1.5,-1.5) -- (0,0) -- cycle;
    
    % Add region labels (Gamma)
    \node at (0.4,0.15) {$\Gamma_1$};
    \node at (0.15,0.4) {$\Gamma_2$};
    \node at (-0.15,0.4) {$\Gamma_3$};
    \node at (-0.4,0.15) {$\Gamma_4$};
    \node at (-0.4,-0.15) {$\Gamma_5$};
    \node at (-0.15,-0.4) {$\Gamma_6$};
    \node at (0.15,-0.4) {$\Gamma_7$};
    \node at (0.4,-0.15) {$\Gamma_8$};
