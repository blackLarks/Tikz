...
\begin{tikzpicture}[
  >=Stealth,
  block/.style = {draw, thick, rounded corners=2pt, minimum height=9mm, minimum width=16mm, align=center},
  sum/.style   = {draw, thick,circle, inner sep=1.5pt, minimum size=4mm},
  line/.style  = {->, thick},
